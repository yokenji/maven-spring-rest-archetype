...
import com.mattheeuws.myportal.util.Pagination;
...
public class PaginationImpl implements Pagination {
  ...
  /* (non-Javadoc)
   * @see com.mattheeuws.fleetmanager.service.util.Pagination#start(java.lang.Integer, java.lang.Integer)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.mattheeuws.fleetmanager.service.util.Pagination#maxPages(java.lang.Integer, java.lang.Long)
   */
  @Override
